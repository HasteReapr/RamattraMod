...
namespace AssassinMod.Modules
{
    ...
    internal static class Skills
    {
        ...
        public static void CreateSkillFamilies(GameObject targetPrefab, bool destroyExisting = true)
        {
            ...
            skillLocator.passiveSkill.skillNameToken = "HASTEREAPR_ASSASSIN_BODY_PASSIVE_NAME";
            skillLocator.passiveSkill.skillDescriptionToken = "HASTEREAPR_ASSASSIN_BODY_PASSIVE_DESCRIPTION";
        ...
        public static GenericSkill CreateGenericSkillWithSkillFamily(GameObject targetPrefab, string familyName, bool hidden = false)
        {
            ...
            AssassinMod.Modules.Content.AddSkillFamily(newFamily);
            return skill;
        }
        #endregion
        ...
        public static T CreateSkillDef<T>(SkillDefInfo skillDefInfo) where T : SkillDef
        {
            ...
            AssassinMod.Modules.Content.AddSkillDef(skillDef);
