        ...
        public static string GetSkinID(AssassinSkin skin)
        {
            switch (skin)
            {
                ...
                case AssassinSkin.DEFAULT:
                    return RamattraPlr.ASSASSIN_PREFIX + "DEFAULT_SKIN_NAME";
                case AssassinSkin.MASTERY:
                    return RamattraPlr.ASSASSIN_PREFIX + "MASTERYUNLOCKABLE_UNLOCKABLE_NAME";
                case AssassinSkin.GRANDMASTERY:
                    return RamattraPlr.ASSASSIN_PREFIX + "GRANDMASTERYUNLOCKABLE_UNLOCKABLE_NAME";
            }
        }
        #endregion
    }
