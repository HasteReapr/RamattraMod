...
namespace RamattraMod.Modules
{
    ...
    {
        internal static GameObject voidShard;
        internal static GameObject voidVortex;
        ...
        private static void CreateVoidShard()
        {
            ...
            voidShard.GetComponent<ProjectileSingleTargetImpact>().hitSoundString = "Play_dagger_impact_ground";
            voidShard.GetComponent<ProjectileSingleTargetImpact>().enemyHitSoundString = "Play_dagger_impact_enemy";
            ...
            shardController.procCoefficient = 0.1f;
